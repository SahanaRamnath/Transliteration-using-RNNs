	...
	while epoch<int(args.epochs) : 
		...
		for i in range(limit) : # each epoch
			...
			if i==limit-1 : 
				...
				print('Train accuracy at end of epoch : ',accuracy)
		...
		# val_ids_temp=val_ids[:]
		# val_eng_temp=val_eng_matrix[:,:].astype(np.int32)
		# val_eng_seqlen_temp=val_eng_seqlen[:].astype(np.int32)
		# val_hindi_temp=val_hindi_matrix[:,:].astype(np.int32)
		# val_hindi_seqlen_temp=val_hindi_seqlen[:].astype(np.int32)
		# val_eng_attn_mask_temp=val_eng_attn_mask[:,:].astype(np.int32)

		# print('Passing validation in a single batch...')
		# [val_ce_loss,predicted_hindi_chars]=train_model.val(sess,val_eng_temp,
		# 	val_eng_seqlen_temp,val_hindi_temp,val_hindi_seqlen_temp,val_eng_attn_mask_temp)
		...
		print('Validation accuracy at epoch '+str(epoch)+' is '+str(accuracy)+' patience is '+str(patience)+' val loss is '+str(val_loss))
